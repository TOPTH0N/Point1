...
@xXStrem.on(events.NewMessage(outgoing=False, pattern='/point1'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhmd_id:
...
@xXStrem.on(events.NewMessage(outgoing=False, pattern='/point2'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhmd_id:
        await event.reply("جاري تجميع النقـاط")
...
@xXStrem.on(events.NewMessage(outgoing=False, pattern='/point3'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhmd_id:
        await event.reply("جاري تجميع النقـاط")
...
@xXStrem.on(events.NewMessage(outgoing=False, pattern='/point4'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhmd_id:
        await event.reply("جاري تجميع النقـاط")
...
@xXStrem.on(events.NewMessage(outgoing=False, pattern='^/point (.*)'))
async def OwnerStart(event):
...
@xXStrem.on(events.NewMessage(outgoing=False, pattern=r'/restart'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhmd_id :
...
@xXStrem.on(events.NewMessage(outgoing=False, pattern=r'^/pt1 (.*)'))
async def OwnerStart(event):
    ...
    sleep(4)
    await xXStrem.send_message(bot_username, pt)
    sleep(4)
    msg = await xXStrem.get_messages(bot_username, limit=1)

    await msg[0].forward_to(ownerhmd_id)
    
@xXStrem.on(events.NewMessage(outgoing=False, pattern=r'^/pt2 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhmd_id :
    ...
    await msg1[0].click(3)
    sleep(4)
    await xXStrem.send_message(bot_usernamee, pt)
    sleep(4)
    msg = await xXStrem.get_messages(bot_usernamee, limit=1)

    await msg[0].forward_to(ownerhmd_id)

@xXStrem.on(events.NewMessage(outgoing=False, pattern=r'^/pt3 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhmd_id :
    ...
    await msg1[0].click(3)
    sleep(4)
    await xXStrem.send_message(bot_usernameee, pt)
    sleep(4)
    msg = await xXStrem.get_messages(bot_usernameee, limit=1)

    await msg[0].forward_to(ownerhmd_id)
    
@xXStrem.on(events.NewMessage(outgoing=False, pattern=r'^/pt4 (.*)'))
async def OwnerStart(event):
    pt = event.pattern_match.group(1) 
    sender = await event.get_sender()
    if sender.id == ownerhmd_id :
    ...
    await msg1[0].click(3)
    sleep(4)
    await xXStrem.send_message(bot_usernameeee, pt)
    sleep(4)
    msg = await xXStrem.get_messages(bot_usernameeee, limit=1)

    await msg[0].forward_to(ownerhmd_id)
    
@xXStrem.on(events.NewMessage(outgoing=False, pattern=r'/npoint1'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhmd_id :
     send = await xXStrem.send_message(bot_username, '/start')
...
@xXStrem.on(events.NewMessage(outgoing=False, pattern=r'/npoint2'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhmd_id :
     send = await xXStrem.send_message(bot_usernamee, '/start')
...
@xXStrem.on(events.NewMessage(outgoing=False, pattern=r'/npoint3'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhmd_id :
     send = await xXStrem.send_message(bot_usernameee, '/start')
...
@xXStrem.on(events.NewMessage(outgoing=False, pattern=r'/npoint4'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhmd_id :
     send = await xXStrem.send_message(bot_usernameeee, '/start')
...
@xXStrem.on(events.NewMessage(outgoing=False, pattern=r'/lpoint'))
async def OwnerStart(event):
    sender = await event.get_sender()
    if sender.id == ownerhmd_id:
